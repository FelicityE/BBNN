...
// std::vector<double> ReLu(double* layer, int stop, int meta = 0){
...
//   return activation;
// }
// std::vector<double> dReLu(double* layer, int stop, int meta = 0){
...
// Layer Functions
///////////////////////////////////////////////////////////////////////////////
// std::vector<double> softMax(double* layer, int stop, int meta = 0){
...
// std::vector<double> dSoftMax(double* layer, int stop, int obs = 0){
...
// std::vector<double> argMax(double* layer, int stop, int meta = 0){
//   double max = layer[0];
